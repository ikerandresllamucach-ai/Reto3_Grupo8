...
public class Registro extends JFrame implements ActionListener{
	...
	public Registro(GestorControlador controlador) {
		...
		Nombre.setBounds(115, 63, 153, 14);
		getContentPane().add(Nombre);
		
		JLabel Apellidos = new JLabel("Apellidos:");
		Apellidos.setBounds(394, 66, 75, 14);
		getContentPane().add(Apellidos);
		
		JLabel Usuario = new JLabel("Usuario:");
		Usuario.setBounds(115, 97, 153, 14);
		getContentPane().add(Usuario);
		
		JLabel Contraseña = new JLabel("Contraseña:");
		Contraseña.setBounds(115, 132, 153, 14);
		getContentPane().add(Contraseña);
		
		JLabel Confirmar = new JLabel("Repetir Contraseña:");
		Confirmar.setBounds(115, 166, 153, 14);
		getContentPane().add(Confirmar);
		
		JLabel fechaNacimiento = new JLabel("Fecha Nacimiento:");
		fechaNacimiento.setBounds(115, 237, 153, 14);
		getContentPane().add(fechaNacimiento);
		
		JLabel fechaRegistro = new JLabel("Fecha Registro:");
		fechaRegistro.setBounds(115, 202, 153, 14);
		getContentPane().add(fechaRegistro);
		
		
		JLabel caducidadPremiun = new JLabel("Caducidad Premium:");
		caducidadPremiun.setBounds(115, 272, 153, 14);
		getContentPane().add(caducidadPremiun);
		
		JLabel Idioma = new JLabel("Idioma:");
		Idioma.setBounds(116, 307, 152, 14);
		...
		idioma.setSize(167, 21);
		idioma.setLocation(211, 180);
	...
	private void cargarDatos() {
	    ...
	    if (u != null) {
	    	this.idUsuario = u.getId_Usuario();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnGuardar) {
		    ...
		    if (esPerfil) {
		        ...
		        boolean exito = controlador.actualizarUsuario(idUsuario,nombre, apellidos, usuario, pass, idio);
		        if (exito) {
		  ...
		  if (e.getSource() == idioma) {
	            String seleccion = (String) this.idioma.getSelectedItem();
	            this.selectIdioma.setText(seleccion);
	        }
